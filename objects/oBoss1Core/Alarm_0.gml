...
arm_instances[arm_number] = enemy_create(enemy_boss_1A, x, -200)
arm_instances[arm_number].parent = id
arm_instances[arm_number].angle = ccnt * 60
arm_instances[arm_number].org = 0
arm_instances[arm_number].dist = 70
arm_number++

arm_instances[arm_number] = enemy_create(enemy_boss_1B, x, -200)
arm_instances[arm_number].parent = id
...
arm_instances[arm_number] = enemy_create(enemy_boss_1C, x, -200)
arm_instances[arm_number].parent = id
