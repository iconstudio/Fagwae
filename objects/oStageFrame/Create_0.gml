...
var jako_pushs_path_selected = jako_path_list[7 - jako_left_first]
...
area_enemy_push(jako_delay, enemy_scout_j1, jako_intro_path_selected, 0, 0)
area_enemy_push(jako_delay, enemy_scout_j1, jako_intro_path_selected, 0, 0)
area_enemy_push(seconds(3.5), jako_shooter, jako_intro_path_selected, 0, 0)
...
if global.extreme {
	...
	area_enemy_push(jako_delay, enemy_scout_j2, jako_pushs_path_selected, 0, 0)
	area_enemy_push(jako_delay, enemy_scout_j2, jako_pushs_path_selected, 0, 0)
	area_enemy_push(seconds(3.5), enemy_scout_j2, jako_pushs_path_selected, 0, 0)
} else {
	...
	area_enemy_push(jako_delay, enemy_scout_j1, jako_fence_path_selected, 0, 0)
	area_enemy_push(jako_delay, enemy_scout_j1, jako_fence_path_selected, 0, 0)
	area_enemy_push(seconds(3.5), enemy_scout_j2, jako_fence_path_selected, 0, 0)
}
...
area_enemy_push(jako_delay, jako_shooter, jako_roams_path_selected, 0, 0)
area_enemy_push(seconds(3.5), enemy_scout_j2, jako_roams_path_selected, 0, 0)
...
area_enemy_push(seconds(3.5), jako_pair_shooter, 0, room_width - jako_pair_left_x, 0)
...
area_enemy_push(seconds(4), enemy_scout_j4, 0, room_width - jako_pair_left_x - 70, 0)
...
area_enemy_push(jako_delay, jako_shooter, jako_intro_path_selected_inverted, 0, 0)
area_enemy_push(jako_delay, jako_shooter, jako_intro_path_selected_inverted, 0, 0)
area_enemy_push(seconds(6.4), jako_shooter, jako_intro_path_selected_inverted, 0, 0)
...
//area_enemy_push(jako_delay, enemy_scout_j2, jako_pushs_path_selected, 0, 0)
//area_enemy_push(jako_delay, enemy_scout_j2, jako_pushs_path_selected, 0, 0)
//area_enemy_push(seconds(4), enemy_scout_j2, jako_pushs_path_selected, 0, 0)
