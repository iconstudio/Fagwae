...
arm_properties[5] = [enemy_create(enemy_square_1, x, y, 0, random(360), id, arm_layer), 40 + random(24), arm_angle]
arm_angle += 75 + random(30)
arm_properties[6] = [enemy_create(enemy_square_1, x, y, 0, random(360), id, arm_layer), 40 + random(24), arm_angle]
arm_angle += 75 + random(30)
arm_properties[7] = [enemy_create(enemy_square_1, x, y, 0, random(360), id, arm_layer), 40 + random(24), arm_angle]
arm_angle += 75 + random(30)
arm_properties[8] = [enemy_create(enemy_square_1, x, y, 0, random(360), id, arm_layer), 40 + random(24), arm_angle]
