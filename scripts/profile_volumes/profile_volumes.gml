...
audio_sound_gain(musicMainMenu, global.setting_music * 0.05, 0)
...
audio_sound_gain(soundShotPlayer, global.setting_sfx * 0.05, 0)
audio_sound_gain(soundShotEnemy, global.setting_sfx * 0.08, 0)
