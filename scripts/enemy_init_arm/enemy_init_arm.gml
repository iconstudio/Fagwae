...
enemy_register(enemy_arm_hexagon_1, oHexagonArm, [sHexagonArmNormal, sHexagonArmExtreme], 10, 200, 1, 0,)

enemy_register(enemy_arm_spread_1, oOctagonSpreaderArm, [sOctagonSpreaderArmNormal, sOctagonSpreaderArmExtreme], 18, 200, 1, 0)

enemy_register(enemy_arm_rectangle_1, oRectangleLauncherArm, [sRectangleArmNormal, sRectangleArmExtreme], 
16, 400, 1, 0)
